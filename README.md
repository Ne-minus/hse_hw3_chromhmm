...
| :-------------: | :------------------: | :------------------: | :------------------: |
| 1     | ![](/data/1.png)     |  <ul><li> чаще всего попадает на ядерную ламину</li><li>наиболее выражена (но слабо) на метке H3K27me3</li><li>в основном попадает в межгенное пространство</li> | Repressed/Nuclear Lamina |
