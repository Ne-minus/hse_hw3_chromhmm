...
| 3     | ![](/data/3.png)     |  <ul><li> часто попадает на ядерную ламину</li><li>выражено метке H3K9me3</li><li>в основном  локализуется в межгенном пространстве</li> | **Heterochromatin**  |
| 4     | ![](/data/4.png)     |  <ul><li> часто попадает на RefSeqTES, RefSeqGene, RefSeq Exon</li><li>выражено метке H3K9me3, H3K36me3</li><li>локализуется на интроне или экзоне</li> | **Weak Transcribed**  |
| 5     | ![](/data/5.png)     |  <ul><li> часто попадает на RefSeqTES, RefSeqGene, RefSeq Exon</li><li>выражено метке H3K36me3</li><li>локализуется на интроне или экзоне</li> | **Weak Transcribed**  |
| 6     | ![](/data/6.png)     |  <ul><li> часто попадает на RefSeqGene</li><li>выражено метке H3K79me2, H3K36me3, H4K20me1</li><li>локализуется на интроне или экзоне</li> | **Weak Transcribed**  |
