...
| 6     | ![](/data/6.png)     |  <ul><li> часто попадает на RefSeqGene</li><li>выражено на метках H3K79me2, H3K36me3, H4K20me1</li><li>локализуется на интроне или экзоне</li> | **Weak Transcribed**  |
| 7     | ![](/data/7.png)     |  <ul><li> часто попадает на RefSeqTES, RefSeqGene, RefSeq Exo, также попадает на RefSeqTSS2kb</li><li>выражено на метках H3K04me1, H3K79me2, H3K36me3, H3K04me2</li><li>локализуется на интроне или экзоне</li> | **Weak Enhancer**  (возможно, Weak promoter, так как попадает на Transcription start site, но смущает, что низкий уровень H3K04me3 (что более характерно как раз для энхансеров))  |
| 8     | ![](/data/8.png)     |  <ul><li> часто попадает на RefSeqGene</li><li>выражено на метках H3K04me1, H3K79me2, H3K36me3, H3K04me2</li><li>локализуется на интроне или экзоне</li> | **Weak Enhancer**  (возможно, Weak promoter, так как попадает на Transcription start site, но смущает, что низкий уровень H3K04me3 (что более характерно как раз для энхансеров)) |
